defmodule UpImgWeb.UserAuth do
  ...
  def log_in_user(conn, user) do
    ...
    # |> redirect(to: ~p"/liveview_clientless")
  ...
  def log_out_user(conn) do
    ...
    #   UpImgWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    # end
  ...
  def signed_in_path(conn) do
    unverified_path(UpImgWeb.Endpoint, UpImgWeb.Router, ~p"/liveview_clientless")
    UpImg.profile_path(conn.assigns.current_user)
  end
end
