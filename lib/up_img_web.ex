defmodule UpImgWeb do
  ...
  def static_paths, do: ~w(assets fonts images favicon.ico robots.txt image_uploads)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: UpImgWeb.Router,
        statics: UpImgWeb.static_paths()
    end
  end
