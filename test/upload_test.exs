...
#   test "upload/1 hUpImgy path REAL Upload" do
#     image = %Plug.Upload{
#       content_type: "image/png",
#       filename: "phoenix.png",
#       path: [:code.priv_dir(:UpImg), "static", "images", "phoenix.png"] |> Path.join()
#     }
...
#     assert UpImg.Upload.upload(image) == {:ok, expected_response}
#   end
...
#       filename: "ginger.jpg",
#       path: [:code.priv_dir(:UpImg), "static", "images", "ginger.jpg"] |> Path.join()
#     }
...
#       path: [:code.priv_dir(:UpImg), "static", "images", "corrupted.jpg"] |> Path.join()
#     }
...
#       content_type: "image/jpeg",
#       filename: "empty.jpg",
#       path: [:code.priv_dir(:UpImg), "static", "images", "empty.jpg"] |> Path.join()
#     }

#     assert UpImg.Upload.upload(image) == {:error, :invalid_cid}
#   end
...
#       content_type: "",
#       filename: "empty",
#       path: [:code.priv_dir(:UpImg), "static", "images", "empty"] |> Path.join()
#     }

#     assert UpImg.Upload.upload(image) == {:error, :invalid_extension_and_cid}
#   end
...
#       path: [:code.priv_dir(:UpImg), "static", "images", "phoenix.xyz"] |> Path.join()
#     }

#     assert UpImg.Upload.upload(image) == {:error, :invalid_extension}
#   end
...
#     file_cid = "anything"
#     file_extension = ".png"
#     assert UpImg.Upload.upload_file_to_s3(file_cid, file_extension, image) == {:error, :upload_fail}
...
#     filename = "empty.pdf"
#     image = %Plug.Upload{
#       content_type: "UpImglication/pdf",
#       filename: filename,
#       path: [:code.priv_dir(:UpImg), "static", "images", filename] |> Path.join()
#     }

#     assert UpImg.Upload.check_file_binary_and_extension(image) == {:error, :invalid_cid}
#   end
# end
